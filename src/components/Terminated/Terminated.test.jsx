  ...
  const component = render(
    <TestingRouter
      ComponentWithRedirection={props => (
        <Terminated location={{ survey }} match={props.match} dataRetreiver={mockDataRetreiver} />
      )}
    />
  );
...
it('Reloading the page with no survey set (F5)', async () => {
  ...
  render(
    <TestingRouter
      ComponentWithRedirection={props => (
        <Terminated location={{}} match={props.match} dataRetreiver={mockDataRetreiver} />
      )}
    />
  );
...
it('Display and hide history', async () => {
  ...
  component.baseElement
    ...
    .querySelector('.HistoryDisplayIcon')
    .click();
